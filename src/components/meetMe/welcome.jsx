...
export const Welcome = () => {
  return (
    <div
      data-glow
      className="flex-1 h-[28rem] flex-col items-center justify-center px-4 py-6 shrink-0 inner-shadow shadow-md shadow-black/50 relative mb-4 lg:mb-0 hidden lg:flex"
    >
