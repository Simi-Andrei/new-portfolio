...
export const Contact = () => {
  ...
  return (
    <div
      data-glow
      className="hidden md:flex max-w-6xl mx-auto relative py-10 pt-14 px-4 lg:px-10 flex-col gap-y-10 md:flex-row items-center justify-between gap-x-10 inner-shadow shadow-md shadow-neutral-400 dark:shadow-neutral-950"
    >
