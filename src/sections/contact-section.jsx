...
export const ContactSection = () => {
  ...
  return (
    <div id="contact" className="my-10 px-4 xl:px-0">
      <div
        data-glow
        className="max-w-6xl mx-auto relative py-10 pt-14 px-4 lg:px-10 flex flex-col gap-y-10 md:flex-row items-center justify-between gap-x-10 inner-shadow shadow-md shadow-neutral-400 dark:shadow-neutral-950"
      >
